...
class SteeringLayoutMici(NavScroller):
  ...
  def __init__(self):
    ...
    # torqued reads both at startup, so an onroad flip would silently do nothing: offroad
    # only, as the TICI torque panel gates them
    ...
    # controlsd picks the tune at startup: offroad only, like the TICI selector
