...
from openpilot.sunnypilot.system.params_migration import ZOOMPILOT_BRANCH, ZOOMPILOT_ORIGIN, _migrate_zoompilot_channel
...
@pytest.mark.parametrize(("origin", "branch"), [
  ...
  (ZOOMPILOT_ORIGIN, "develop"),          # develop users are not hijacked
