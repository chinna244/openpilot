...
hand-back first and then grants OffroadMode once disengaged and at a standstill (see
...
in time, under the same standstill gate. Leaving offroad needs no coordination and
clears OffroadMode directly. sunnylink's remote Force Offroad toggle uses this same
entry point (openpilot/sunnypilot/sunnylink/athena/sunnylinkd.py).
"""
